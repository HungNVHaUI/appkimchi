...
class TTextTheme  {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w600, color: Colors.black.withOpacity(0.8)),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 16.0, fontWeight: FontWeight.w600, color: Colors.white.withOpacity(0.8)),
